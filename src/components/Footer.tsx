  ...
  return (
    <footer className="text-[18px] text-center lg:text-start flex flex-col-reverse gap-5 lg:flex-row lg:justify-between mb-10">
      <div className="flex flex-col lg:flex-row gap-5 lg:gap-8">
        <Link spy={true} smooth={true} offset={-70} duration={500} to="home">Home</Link>
        <Link spy={true} smooth={true} offset={-70} duration={500} to="about">About</Link>
        <Link spy={true} smooth={true} offset={-70} duration={500} to="tech">Tech Stack</Link>
        <Link spy={true} smooth={true} offset={-70} duration={500} to="experience">Work</Link>
