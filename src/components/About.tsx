...
const ServiceCard = ({ title, icon }: serviceType) => {
    return (
        <div className='xs:w-[250px] w-full transform hover:translate-y-3 duration-300'>
        ...
        <section id='about' className={styles.sections}>
            <div className={styles.FlexCol}>
                ...
                <p className='text-secondary text-[1.1925rem] max-w-4xl mx-auto leading-[30px]'>
                    I'm a skilled software engineer with experience with
                    Typescipt and Javascript , and expertise in libraries like
                    React, Three.js, Next.js, and Node.js. I'm a quick learner
