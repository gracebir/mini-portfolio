...
function Hero() {
    return (
        <section id="home" className="flex flex-col gap-20 py-12 px-4 lg:px-0 lg:py-0 items-center lg:flex-row lg:justify-between lg:items-center h-[86vh] lg:h-[86vh]">
