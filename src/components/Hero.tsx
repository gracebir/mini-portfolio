...
function Hero() {
    return (
        <section id="home" className="flex flex-col-reverse gap-20 md:mt-0 lg:mt-0 px-4 lg:px-0 lg:py-0 items-center lg:flex-row lg:justify-between lg:items-center h-[100vh] mb-32 lg:h-[87vh]">
