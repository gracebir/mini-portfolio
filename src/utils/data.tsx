...
export const projects: Array<projectType> = [
  {
    id: 1,
    title: "Countries API",
    description: "The Rest Countries Explorer project is a front-end web application that leverages the Rest Countries API to provide comprehensive information about various countries around the world. The application allows users to explore details of individual countries, search for specific countries, and filter countries based on their respective continents.",
    image: country,
    techStacks: ['React.js', 'Tailwindcss', 'Formik', 'Responsive Design', 'API Integration'],
  ...
  },
  {
    ...
    description: "In this challenge, your mission is to enhance a multi-step form to closely match the provided design. Your goal is to create a seamless user experience by allowing users to progress through the form's steps, review and edit their selections, and ultimately confirm their order. The challenge empowers you to leverage your preferred tools and skills to achieve the desired outcome.",
    image: multiForm,
